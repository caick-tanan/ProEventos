...
export class RedesSociaisComponent implements OnInit {
  ...
  ngOnInit() {
    this.carregarRedesSociais(this.eventoId) // Caso possua eventoId
    this.validation();
  }

  private carregarRedesSociais(id: number = 0): void {
    let origem = 'palestrante'; // O padrão é palestrante

    if (this.eventoId !== 0) origem = 'evento'; // Mas se o evento for diferente de 0 ele passa ser evento
